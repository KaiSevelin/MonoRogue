...
using Monogame.Core.Effects;
using Monogame.Core.Localization;
using Monogame.Core.Settings;
using Monogame.ScreenManagers;
...
namespace Monogame.Core
{
    ...
    public class MonogameGame : Game
    {
        ...
        private SettingsManager<MonogameSettings> settingsManager;

        // Manages leaderboard data for tracking high scores and achievements.
        private SettingsManager<MonogameLeaderboard> leaderboardManager;
        ...
        public MonogameGame()
        {
            ...
            settingsManager = new SettingsManager<MonogameSettings>(storage);
            Services.AddService(typeof(SettingsManager<MonogameSettings>), settingsManager);

            leaderboardManager = new SettingsManager<MonogameLeaderboard>(storage);
            Services.AddService(typeof(SettingsManager<MonogameLeaderboard>), leaderboardManager);
